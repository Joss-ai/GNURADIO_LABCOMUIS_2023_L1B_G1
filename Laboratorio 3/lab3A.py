...
class lab3A(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "calculo potencias", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("calculo potencias")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab3A")
        ...
        self._A_range = Range(1, 10, 0.5, 1, 200)
...
def main(top_block_cls=lab3A, options=None):
