...
# Author: JoseAlgarin_DiegoPalencia
...
class Lab3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.USRP.set_time_now(uhd.time_spec(time.time()), uhd.ALL_MBOARDS)

        self.USRP.set_center_freq(fc, 0)
        self.USRP.set_antenna("TX/RX", 0)
        self.USRP.set_gain(GTX, 0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.USRP, 0))
    ...
    def set_fc(self, fc):
        self.fc = fc
        self.USRP.set_center_freq(self.fc, 0)
