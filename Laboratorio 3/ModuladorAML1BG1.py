...
class ModuladorAML1BG1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, Ac=1, ka=1):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModuladorAML1BG1")
...
def argument_parser():
    ...
    parser.add_argument(
        ...
        help="Set Amplitud frecuencia portadora [default=%(default)r]")
    parser.add_argument(
...
def main(top_block_cls=ModuladorAML1BG1, options=None):
    if options is None:
