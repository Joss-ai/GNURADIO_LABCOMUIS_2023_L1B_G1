...
class lab1b_punto5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1b_punto5")
        ...
        self.high_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.high_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Documentos/Jose_Diego_comu1/Laboratorio 2/gitana_williecolon.wav', True)
...
def main(top_block_cls=lab1b_punto5, options=None):
