...
# Author: Jose_Algarin_Diego_Palencia_J1C_G1
...
class lab1B_punto1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1B_punto1")
...
def main(top_block_cls=lab1B_punto1, options=None):
