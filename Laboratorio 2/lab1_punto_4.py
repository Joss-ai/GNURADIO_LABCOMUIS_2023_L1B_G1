...
class lab1_punto_4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "laboratorio 1b parte 2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("laboratorio 1b parte 2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1_punto_4")
...
def main(top_block_cls=lab1_punto_4, options=None):
